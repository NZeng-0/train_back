...
public interface SeatMapper {
    ...
    // 根据 车厢 和 座位查询
    @Select("SELECT id FROM t_seat WHERE train_id = #{train_id} AND carriage_number = #{carriage_number} AND seat_number = #{seat_number}")
    Long getSeatByCoachAndNumber(@Param("train_id") String trainId, @Param("carriage_number") String coachId, @Param("seat_number") String seatNumber);
}